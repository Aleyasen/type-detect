 ...
 *
 * {@code Grok} is simple API that allows you to easily parse logs and other
 * files (single line). With {@code Grok}, you can turn unstructured log and
 * event data into structured data (JSON).
 * <br>
 * example:<br>
 * <pre>
...
public class Grok implements Serializable {
    ...
    /**
     * Map of the named regex of the originalGrokPattern with id = namedregexid
     * and value = namedregex.
     */
    ...
    /**
     * Create a {@code Grok} instance with the given patterns file and a
     * {@code Grok} pattern.
     *
     * @param grokPatternPath Path to the pattern file
     * @param grokExpression - <b>OPTIONAL</b> - Grok pattern to compile ex:
     * %{APACHELOG}
     ...
     * {@code Grok}, duplicate element will be override.
     *
    ...
    /**
     * Match the given <tt>log</tt> with the named regex. And return the json
     * representation of the matched element
     *
    ...
    /**
     * Match the given list of <tt>log</tt> with the named regex and return the
     * list of json representation of the matched elements.
     *
    ...
    /**
     * Match the given <tt>text</tt> with the named regex {@code Grok} will
     * extract data from the string and get an extence of {@link Match}.
     *
     ...
     *
     * @param pattern : Grok pattern (ex: %{IP})
     * @param namedOnly : Whether to capture named expressions only or not (i.e.
     * %{IP:ip} but not ${IP})
     * @throws GrokException runtime expt
     */
    ...
    /**
     * {@code Grok} will try to find the best expression that will match your
     * input. {@link Discovery}
     *
